  ...
  return (
    <div className=" mt-24">
      <div className="grid grid-cols-2  h-[901px] ">
        ...
        <div className="item bg-defaultyellow ps-10 pt-12 grid">
          ...
          <div className="image_slider grid grid-cols-3 justify-between gap-8  item-end  items-end mb-36 ">
            {Name.map(({ id, name, post }) => (
              <div className="items bg-white p-9" key={id}>
                <h1 className="text-3git bxl  ">{name}</h1>
                <p>{post}</p>
