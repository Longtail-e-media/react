...
class Member extends DatabaseObject
{
    ...
    protected static $db_fields = array('id', 'name', 'position', 'image', 'status', 'sortorder', 'added_date', 'modified_date');

    public $id, $name, $position, $image, $status, $sortorder, $added_date, $modified_date;
